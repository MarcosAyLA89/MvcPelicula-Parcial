...
namespace MvcPelicula.Controllers
{
    public class DirectoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Apellido,Edad,TotalPeliculas")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Apellido,Edad,TotalPeliculas")] Director director)
        {
            if (ModelState.IsValid)
            {
